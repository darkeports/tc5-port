...
import thaumcraft.codechicken.libold.lighting.LightModel;
...
import thaumcraft.codechicken.libold.vec.TransformationList;
import thaumcraft.codechicken.libold.vec.Vector3;
/*      */ 
/*      */ public class CCModel implements CCRenderState.IVertexSource, thaumcraft.codechicken.libold.util.Copyable<CCModel>
/*      */ {
...
/*  514 */       coordSystem = new thaumcraft.codechicken.libold.vec.RedundantTransformation();
...
/*      */     try
/*      */     {
/*  646 */       return parseObjModels(Minecraft.getMinecraft().getResourceManager().getResource(res).getInputStream(), 4, coordSystem);
/*      */ 
/*      */     }
/*      */     catch (IOException e)
/*      */     {
...
/*      */     try
/*      */     {
/*  667 */       return parseObjModels(Minecraft.getMinecraft().getResourceManager().getResource(res).getInputStream(), vertexMode, coordSystem);
/*      */ 
/*      */     }
/*      */     catch (Exception e)
/*      */     {
...
/*  814 */     return model.apply(new TransformationList(new Transformation[] { (Transformation)thaumcraft.codechicken.libold.vec.Rotation.sideRotations[side1].inverse(), thaumcraft.codechicken.libold.vec.Rotation.sideRotations[side2] }).at(point));
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/*      */   {
/*  944 */     return apply(new TransformationList(new Transformation[] { (Transformation)thaumcraft.codechicken.libold.vec.Rotation.sideRotations[side1].inverse(), thaumcraft.codechicken.libold.vec.Rotation.sideRotations[side2] }).at(point), srcpos, destpos, length);
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/* Location:              C:\Users\Alex\Desktop\Thaumcraft-1.8.9-5.2.4-deobf.jar!\thaumcraft\codechicken\lib\render\CCModel.class
