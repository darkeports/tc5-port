...
/*    */ 
/*    */ public class PacketFXSlash implements IMessage, net.minecraftforge.fml.common.network.simpleimpl.IMessageHandler<PacketFXSlash, IMessage>
/*    */ {
/*    */   private int source;
/*    */   private int target;
/*    */   
...
/*    */   public IMessage onMessage(PacketFXSlash message, net.minecraftforge.fml.common.network.simpleimpl.MessageContext ctx)
/*    */   {
...
/* 47 */       thaumcraft.common.Thaumcraft.proxy.getFX().drawSlash(var2.posX, var2.getEntityBoundingBox().minY + var2.height / 2.0F, var2.posZ, var3.posX, var3.getEntityBoundingBox().minY + var3.height / 2.0F, var3.posZ, 8);
/*    */     }
/*    */     
/*    */ 
/*    */ 
...
/*    */   {
/* 58 */     return par1 == mc.thePlayer.getEntityId() ? mc.thePlayer : world.getEntityByID(par1);
/*    */   }
/*    */ }
