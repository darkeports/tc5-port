...
/* 16 */       target.addPotionEffect(new net.minecraft.potion.PotionEffect(Potion.wither.id, 200));
/*    */     }
/* 18 */     return amount;
/*    */   }
/*    */   
...
/*    */     
/* 29 */     Thaumcraft.proxy.getFX().drawGenericParticles(boss.getEntityBoundingBox().minX + w, boss.getEntityBoundingBox().minY + h, boss.getEntityBoundingBox().minZ + d, 0.0D, -0.02D, 0.0D, boss.worldObj.rand.nextFloat() * 0.2F, boss.worldObj.rand.nextFloat() * 0.2F, boss.worldObj.rand.nextFloat() * 0.2F, 0.8F, false, 160, 10, 1, 8 + boss.worldObj.rand.nextInt(4), 0, 0.6F + boss.worldObj.rand.nextFloat() * 0.4F, 0.0F, 0);
/*    */   }
/*    */ }


/* Location:              C:\Users\Alex\Desktop\Thaumcraft-1.8.9-5.2.4-deobf.jar!\thaumcraft\common\entities\monster\mods\ChampionModGrim.class
