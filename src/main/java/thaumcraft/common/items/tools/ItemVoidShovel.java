...
/*    */   {
/* 53 */     if ((!player.worldObj.isRemote) && ((entity instanceof EntityLivingBase)) && (
/* 54 */       (!(entity instanceof EntityPlayer)) || (MinecraftServer.getServer().isPVPEnabled())))
/*    */     {
/*    */ 
/* 57 */       ((EntityLivingBase)entity).addPotionEffect(new PotionEffect(Potion.weakness.getId(), 80));
/*    */     }
/*    */     
...
/* Location:              C:\Users\Alex\Desktop\Thaumcraft-1.8.9-5.2.4-deobf.jar!\thaumcraft\common\items\tools\ItemVoidShovel.class
