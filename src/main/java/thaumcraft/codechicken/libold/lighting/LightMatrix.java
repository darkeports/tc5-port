...
/*     */ {
/*  16 */   public static final int operationIndex = ;
/*     */   
...
/*     */ 
/*     */ 
/*  51 */   public static final float[] sideao = { 0.5F, 1.0F, 0.8F, 0.8F, 0.6F, 0.6F, 0.5F, 1.0F, 0.8F, 0.8F, 0.6F, 0.6F, 1.0F };
/*     */   
/*     */ 
/*     */ 
/*     */ 
...
/*  90 */       IBlockState b = this.access.getBlockState(new BlockPos(x, y, z));
/*  91 */       this.bSamples[i] = this.access.getCombinedLight(new BlockPos(x, y, z), b.getBlock().getLightValue(this.access, new BlockPos(x, y, z)));
/*  92 */       this.aSamples[i] = b.getBlock().getAmbientOcclusionLightValue();
/*     */     }
/*     */   }
/*     */   
...
/* 111 */         if (Minecraft.isAmbientOcclusionEnabled()) {
...
/*     */   {
/* 159 */     return operationIndex;
/*     */   }
/*     */ }


/* Location:              C:\Users\Alex\Desktop\Thaumcraft-1.8.9-5.2.4-deobf.jar!\thaumcraft\codechicken\lib\lighting\LightMatrix.class
