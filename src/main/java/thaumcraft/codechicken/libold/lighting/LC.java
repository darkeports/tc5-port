...
import thaumcraft.codechicken.libold.render.CCModel;
...
/* 76 */     Vector3 v1 = thaumcraft.codechicken.libold.vec.Rotation.axes[(((side & 0xE) + 3) % 6)];
/* 77 */     Vector3 v2 = thaumcraft.codechicken.libold.vec.Rotation.axes[(((side & 0xE) + 5) % 6)];
...
/* Location:              C:\Users\Alex\Desktop\Thaumcraft-1.8.9-5.2.4-deobf.jar!\thaumcraft\codechicken\lib\lighting\LC.class
